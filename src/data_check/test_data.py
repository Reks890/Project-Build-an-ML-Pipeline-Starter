...
def test_row_count(data):
    """
    Tests to validate whether the dataset falls within a range of 15000 (too small)
    or 1000000 (too large) for this project.
    """    
    assert 15000 < data.shape[0] < 1000000

def test_price_range(data, min_price, max_price):
    """
    Tests to validate whether all 'price' column values fall within declared range min:max
    """
